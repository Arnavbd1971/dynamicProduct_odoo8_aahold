...
class Dynamic_product_template(models.Model):
	...
	def concatenate_custom_fields(self):
		...
		if str(self.trade_name) == '100% Cotton' or str(self.trade_name) == '100% Viscose' or str(self.trade_name) == '100% Modal' or str(self.trade_name) == '100% Tencel' or str(self.trade_name) == '100% Polyester':
			self.combined_name = str(self.ring_spun_count) + '/' + str(self.twist_count) + ' ' + str(self.compact_state) + ' ' + str(self.process) + ' ' + str(self.trade_name) + ' ' + str(self.slub) + ' ' + str(self.contamination) + ' ' + str(self.yarn_process) + ' ( H.S Code: ' + str(self.hs_code) + ' ) ' 
			self.name= self.combined_name
		else:
			if self.dyed_cotton_percentage:
				self.combined_name = str(self.ring_spun_count) + '/' + str(self.twist_count) + ' ' + str(self.compact_state) + ' ' + str(self.process) + ' ' + str(self.trade_name) + ' ' + str(self.slub) + ' (Cotton ' + str(self.cotton_percentage) + '%-' + str(self.cotton_type) + ' + Dyed Cotton ' + str(self.dyed_cotton_percentage) + '%' + ') ' + str(self.contamination) + ' ' + str(self.yarn_process) + ' ( H.S Code: ' + str(self.hs_code) + ' ) '
				self.name= self.combined_name

			elif self.white_viscose_percentage:
				self.combined_name = str(self.ring_spun_count) + '/' + str(self.twist_count) + ' ' + str(self.compact_state) + ' ' + str(self.process) + ' ' + str(self.trade_name) + ' ' + str(self.slub) + ' (Cotton ' + str(self.cotton_percentage) + '%-' + str(self.cotton_type) + ' + White Viscose ' + str(self.white_viscose_percentage) + '%' + ') ' + str(self.contamination) + ' ' + str(self.yarn_process) + ' ( H.S Code: ' + str(self.hs_code) + ' ) '
				self.name= self.combined_name

			elif self.dyed_viscose_percentage:
				self.combined_name = str(self.ring_spun_count) + '/' + str(self.twist_count) + ' ' + str(self.compact_state) + ' ' + str(self.process) + ' ' + str(self.trade_name) + ' ' + str(self.slub) + ' (Cotton ' + str(self.cotton_percentage) + '%-' + str(self.cotton_type) + ' + Dyed Viscose' + str(self.dyed_viscose_percentage) + '%' + ') ' + str(self.contamination) + ' ' + str(self.yarn_process) + ' ( H.S Code: ' + str(self.hs_code) + ' ) '
				self.name= self.combined_name

			elif self.polyester_percentage:
				self.combined_name = str(self.ring_spun_count) + '/' + str(self.twist_count) + ' ' + str(self.compact_state) + ' ' + str(self.process) + ' ' + str(self.trade_name) + ' ' + str(self.slub) + ' (Cotton ' + str(self.cotton_percentage) + '%-' + str(self.cotton_type) + ' + Polyster ' + str(self.polyester_percentage) + '%' + ') ' + str(self.contamination) + ' ' + str(self.yarn_process) + ' ( H.S Code: ' + str(self.hs_code) + ' ) '
				self.name= self.combined_name

			elif self.linen_percentage:
				self.combined_name = str(self.ring_spun_count) + '/' + str(self.twist_count) + ' ' + str(self.compact_state) + ' ' + str(self.process) + ' ' + str(self.trade_name) + ' ' + str(self.slub) + ' (Cotton ' + str(self.cotton_percentage) + '%-' + str(self.cotton_type) + ' + Linen ' + str(self.linen_percentage) + '%' + ') ' + str(self.contamination) + ' ' + str(self.yarn_process) + ' ( H.S Code: ' + str(self.hs_code) + ' ) '
				self.name= self.combined_name

			elif self.tencel_percentage:
				self.combined_name = str(self.ring_spun_count) + '/' + str(self.twist_count) + ' ' + str(self.compact_state) + ' ' + str(self.process) + ' ' + str(self.trade_name) + ' ' + str(self.slub) + ' (Cotton ' + str(self.cotton_percentage) + '%-' + str(self.cotton_type) + ' + Tencel ' + str(self.tencel_percentage) + '%' + ') ' + str(self.contamination) + ' ' + str(self.yarn_process) + ' ( H.S Code: ' + str(self.hs_code) + ' ) '
				self.name= self.combined_name
